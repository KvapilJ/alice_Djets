...
Double_t ptmin = fptbinsDA[0], ptmax = fptbinsDA[fptbinsDN];
...
Double_t jetptmin = 2, Double_t jetptmax = 50, Bool_t recoPt = 0, Bool_t postfix = 0, TString listName = "", Bool_t isprefix = 0 )
{
    ...
    TH1D *hpt_mc_reb = dynamic_cast<TH1D*>(hMCpt->Rebin(fptbinsDN,"hpt_mc_reb",fptbinsDA));
    TH1D *hpt_reco_reb = dynamic_cast<TH1D*>(hMCpt_reco->Rebin(fptbinsDN,"hpt_reco_reb",fptbinsDA));
