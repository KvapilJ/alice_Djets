...
void makeTFile4CutsD0Jet_pp5TeV_root6T3(Bool_t isOnData = kTRUE){
...
RDHFD0toKpi->SetTriggerClass("");
  ...
  RDHFD0toKpi->SetPtBins(nptbins+1,ptbins);
												 // m       dca    ThSt ptk ptp     d0k       d0p         d02     thp cosxy NLxy
  Float_t cutsMatrixD0toKpiStand[nptbins][nvars]={{0.400,275.*1E-4,0.8,0.5,0.5,1000.*1E-4,1000.*1E-4,-40000.*1E-8,0.95,0.,5.},   /*BIN 0*/ /* pt<0.5*/
                                                  {0.400,275.*1E-4,0.8,0.5,0.5,1000.*1E-4,1000.*1E-4,-40000.*1E-8,0.95,0.,5.},   /*BIN 1*/ /* 0.5<pt<1*/
                                                  {0.400,275.*1E-4,0.8,0.5,0.5,1000.*1E-4,1000.*1E-4,-40000.*1E-8,0.95,0.,5.}, /*BIN 2*/ /* 1<pt<2 */
                                                  {0.400,275.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-40000.*1E-8,0.95,0.,5.}, /*BIN 3*/ /* 2<pt<3 */
                                                  {0.400,275.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-40000.*1E-8,0.95,0.,5.}, /*BIN 4*/ /* 3<pt<4 */
                                                  {0.400,275.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-20000.*1E-8,0.95,0.,5.}, /*BIN 5*/ /* 4<pt<5 */
                                                  {0.400,275.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-15000.*1E-8,0.95,0.,4.}, /*BIN 6*/ /* 5<pt<6 */
                                                  {0.400,275.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-12000.*1E-8,0.95,0.,4.},  /*BIN 7*/ /* 6<pt<7 */
                                                  {0.400,275.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-12000.*1E-8,0.95,0.,4.},  /*BIN 8*/ /* 7<pt<8 */
                                                  {0.400,275.*1E-4,0.9,0.7,0.7,1000.*1E-4,1000.*1E-4, -8000.*1E-8,0.95,0.,3.},  /*BIN 9*/ /* 8<pt<10 */
                                                  {0.400,275.*1E-4,0.9,0.7,0.7,1000.*1E-4,1000.*1E-4, -8000.*1E-8,0.95,0.,3.},  /*BIN 10*/ /* 10<pt<12 */
                                                  {0.400,275.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,  5000.*1E-8,0.95,0.,3.},  /*BIN 11*/ /* 12<pt<16 */
                                                  {0.400,275.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,  5000.*1E-8,0.95,0.,3.},  /*BIN 12*/ /* 16<pt<24 */
                                                  {0.400,275.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,  5000.*1E-8,0.90,0.,3.}}; /*BIN 13*/ /* pt>24 */

//topomatic cut
  Float_t d0Topomatic[nptbins] = {1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5};
  ...
  TFile* fout;
  if(isOnData) fout=new TFile("D0toKpiCuts_Std_pp2017_T3.root","recreate");   //set this!!
  else fout=new TFile("D0toKpiCuts_Std_pp2017_T3.root","recreate");   //set this!!
