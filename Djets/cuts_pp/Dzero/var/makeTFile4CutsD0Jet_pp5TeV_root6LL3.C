...
void makeTFile4CutsD0Jet_pp5TeV_root6LL3(Bool_t isOnData = kTRUE){
...
RDHFD0toKpi->SetTriggerClass("");
  ...
  Float_t cutsMatrixD0toKpiStand[nptbins][nvars]={{0.400,350.*1E-4,0.8,0.5,0.5,1000.*1E-4,1000.*1E-4,-25000.*1E-8,0.8,0.,5.},   /*BIN 0*/ /* pt<0.5*/
                                                  ...
                                                  {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4,999999.*1E-8,0.85,0.,3.}}; /*BIN 13*/ /* pt>24 */
...
//topomatic cut
  ...
  TFile* fout;
  if(isOnData) fout=new TFile("D0toKpiCuts_Std_pp2017_L3.root","recreate");   //set this!!
  else fout=new TFile("D0toKpiCuts_Std_pp2017_L3.root","recreate");   //set this!!
