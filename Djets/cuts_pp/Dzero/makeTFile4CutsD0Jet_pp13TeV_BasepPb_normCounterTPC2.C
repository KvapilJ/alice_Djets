...
//topomatic cut
  ...
  TFile* fout;
  if(isOnData) fout=new TFile("D0toKpiCuts_pp13TeV_pPbBase_newNormTPC2.root","recreate");   //set this!!
  else fout=new TFile("D0toKpiCuts_pp13TeV_pPbBase_newNormTPC2.root","recreate");   //set this!!
