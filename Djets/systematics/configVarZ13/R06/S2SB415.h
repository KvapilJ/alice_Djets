...
enum Observable {kXsection=0, kFragmentation=1};
    ...
    const double  fRpar = 0.6;           //-----! jet R parameter for your studies (the one that you use in your jet finder!)
    const int     Rpar = 6;
...
//    double        fptbinsJetFinalA[fptbinsJetFinalN+1] = { 5,6,8,10,12,14,20,30,50};
   ...
   double        fzbinsJetFinalA[fzptJetMeasN][10] ={
    ...
    const int     fzptbinsDN[fzptJetMeasN]={3,5,4,9,9};
    double        fzptbinsDA[fzptJetMeasN][12] = {{2,3,4,5},
                                                 {2,3,4,5,6,7},
                                                 {2,3,4,5,6,7,8,10},
                                                 {2,3,4,5,6,7,8,10,12,16},
                                                 {4,5,6,7,8,10,12,16,24,36}};
    const int     fzptbinsDPromptN[fzptJetMeasN]={3,5,4,9,9};
