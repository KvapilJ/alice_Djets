 ...
 //   const int     fptbinsDN = 7;
  //  double        fptbinsDA[fptbinsDN+1] = {2,4,5,6,7,8,12,24};
   ...
   double        fzbinsJetFinalA[fzptJetMeasN][10] = {{0.4,0.5,0.6,0.7,0.8,0.9,1.0},
    ...
    const int     fzptbinsDN[fzptJetMeasN]={2,4,6,8,10};
    double        fzptbinsDA[fzptJetMeasN][12] = {{3,4,5},
                                                 {3,4,5,6,7},
                                                 {3,4,5,6,7,8,10},
                                                 {3,4,5,6,7,8,10,12,15},
                                                 {3,4,5,6,7,8,10,12,16,24,36}};
    const int     fzptbinsDPromptN[fzptJetMeasN]={2,4,6,8,10};
    double        fzptbinsDPromptA[fzptJetMeasN][12] = {{3,4,5},
                                                        {3,4,5,6,7},
                                                        {3,4,5,6,7,8,10},
                                                        {3,4,5,6,7,8,10,12,15},
                                                        {3,4,5,6,7,8,10,12,16,24,36},
