...
void drawRM()
{
   ...
   TFile *inFileFD1 = new TFile("/home/kvapil/work/analysis/pp_run2/D0jet/BaseCuts_X04/Response.root","read");

    TH2D *hFD_ratio = (TH2D*)inFileFD1->Get("RM");
if(!hFD_ratio) std::cout<<"NOT FOUND"<<std::endl;


            hFD_ratio->SetTitle("");
            hFD_ratio->GetXaxis()->SetTitle("#it{p}_{T,ch jet}^{det} (GeV/#it{c})");
            hFD_ratio->GetXaxis()->SetLabelSize(0.04);
            hFD_ratio->GetXaxis()->SetTitleSize(0.032);
            hFD_ratio->GetXaxis()->SetTitleOffset(1.2);
            hFD_ratio->GetYaxis()->SetTitle("#it{p}_{T,ch jet}^{gen} (GeV/#it{c})");
            hFD_ratio->GetYaxis()->SetTitleOffset(1.2);
            hFD_ratio->GetYaxis()->SetLabelSize(0.04);
...
std::cout<<"NOT"<<std::endl;
    ...
    TPaveText *pt = new TPaveText(0.56,0.75,0.9,0.95,"NB NDC");
    pt->SetBorderSize(0);
    pt->SetFillStyle(0);
    pt->SetTextAlign(13);
    pt->SetTextFont(42);
    ...
    text = pt->AddText("charged jets with D^{0}, anti-#it{k}_{T}");
...
std::cout<<"NOT"<<std::endl;
    ...
    cEff->cd()->SetTopMargin(.02);
    cEff->cd()->SetRightMargin(.12);
