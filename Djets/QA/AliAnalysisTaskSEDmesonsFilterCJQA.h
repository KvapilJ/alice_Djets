#ifndef ALIANALYSISTASKSEDMESONSFILTERCJQA_H
#define ALIANALYSISTASKSEDMESONSFILTERCJQA_H
/**************************************************************************
...
class AliAnalysisTaskSEDmesonsFilterCJQA : public AliAnalysisTaskEmcal
{
 ...
 public:
  ...
  AliAnalysisTaskSEDmesonsFilterCJQA();
  AliAnalysisTaskSEDmesonsFilterCJQA(const Char_t* name,AliRDHFCuts* cuts,ECandidateType candtype);
  virtual ~AliAnalysisTaskSEDmesonsFilterCJQA();
