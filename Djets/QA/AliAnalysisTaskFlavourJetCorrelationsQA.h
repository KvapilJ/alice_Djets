...
class AliAnalysisTaskFlavourJetCorrelationsQA : public AliAnalysisTaskEmcalJet
{
...
public:
   ...
   AliAnalysisTaskFlavourJetCorrelationsQA();
   AliAnalysisTaskFlavourJetCorrelationsQA(const Char_t* name,AliRDHFCuts* cuts, ECandidateType candtype);
   virtual ~AliAnalysisTaskFlavourJetCorrelationsQA();
...
private:
   ...
   AliAnalysisTaskFlavourJetCorrelationsQA(const AliAnalysisTaskFlavourJetCorrelationsQA &source);
   AliAnalysisTaskFlavourJetCorrelationsQA& operator=(const AliAnalysisTaskFlavourJetCorrelationsQA& source);
