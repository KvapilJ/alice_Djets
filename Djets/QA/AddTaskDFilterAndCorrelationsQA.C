...
AliAnalysisTaskFlavourJetCorrelationsQA *AddTaskDFilterAndCorrelationsQA(
  AliAnalysisTaskFlavourJetCorrelationsQA::ECandidateType cand = AliAnalysisTaskFlavourJetCorrelationsQA::kDstartoKpipi,
  ...
  AliAnalysisTaskFlavourJetCorrelationsQA::ECorrelationMethod CorrMethod = AliAnalysisTaskFlavourJetCorrelationsQA::kConstituent
)
{
  ...
  AliAnalysisTaskFlavourJetCorrelationsQA *taskCorr = new AliAnalysisTaskFlavourJetCorrelationsQA(taskCorrName.Data(), analysiscuts, cand);
