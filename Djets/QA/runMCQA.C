...
const char*    runPeriod           = "LHC18l4a";                    // set the run period (used on grid)
...
void runAnalysis()
{
    ...
    //                        gSystem->ExpandPathName("AddTasksFlavourJetMCQA.C"),0);
        ...
        AliAnalysisTaskSEDmesonsFilterCJQA *filter = reinterpret_cast<AliAnalysisTaskSEDmesonsFilterCJQA*>(
                    ...
                    gSystem->ExpandPathName("AddTaskSEDmesonsFilterCJQA.C"),AliAnalysisTaskSEDmesonsFilterCJQA::ECandidateType::kD0toKpi,
                    cutFile.Data(),
                    isRunOnMC,
                    isReco,
                    TaskText.Data())));
