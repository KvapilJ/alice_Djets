...
ClassImp(AliAnalysisTaskSEDmesonsFilterCJQA)

//_______________________________________________________________________________
AliAnalysisTaskSEDmesonsFilterCJQA::AliAnalysisTaskSEDmesonsFilterCJQA() :
...
//_______________________________________________________________________________
AliAnalysisTaskSEDmesonsFilterCJQA::AliAnalysisTaskSEDmesonsFilterCJQA(const char *name, AliRDHFCuts *cuts, ECandidateType candtype) :
  ...
  fHistDeltaRDKR(0)
{
  ...
  Info("AliAnalysisTaskSEDmesonsFilterCJQA","Calling Constructor");
  ...
  switch (fCandidateType) {
    ...
    case 1 :
      ...
      break;
    default :
      Warning("AliAnalysisTaskSEDmesonsFilterCJQA", "%d not accepted!!", fCandidateType);
      break;
  }
...
AliAnalysisTaskSEDmesonsFilterCJQA::~AliAnalysisTaskSEDmesonsFilterCJQA()
{
  ...
  Info("~AliAnalysisTaskSEDmesonsFilterCJQA","Calling Destructor");
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJQA::Init()
{
  //
  // Initialization
  //
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJQA::UserCreateOutputObjects()
{
  //
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJQA::ExecOnce()
{
  //
...
//_______________________________________________________________________________
Bool_t AliAnalysisTaskSEDmesonsFilterCJQA::Run()
{
  //
  // Analysis execution
  //
    ...
    if (fNCand==fAnalyseCand){  
        ...
        for (Int_t icharm = 0; icharm < nD; icharm++) {  
          ...
          if (fCandidateType == kDstartoKpipi) {
              ...
              if (!dstar) {
                Error("AliAnalysisTaskSEDmesonsFilterCJQA::UserExec","Candidate type is D* but object type is wrong (should be AliAODRecoCascadeHF)");
                continue;
              }
          }
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJQA::ProcessD0(AliAODRecoDecayHF2Prong* charmCand, Int_t isSelected)
{
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJQA::ProcessDstar(AliAODRecoCascadeHF* dstar, Int_t isSelected)
{
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJQA::FillD0MCTruthKinHistos(AliAODRecoDecayHF2Prong* charmCand, Int_t isSelected, Int_t isD0)
{
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJQA::FillDStarMCTruthKinHistos(AliAODRecoCascadeHF* dstar, Int_t isSelected, Int_t isDstar)
{
  // Fill some histogram with kinematic information of the D0 candidate.
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJQA::FillDstarSideBands(AliAODRecoCascadeHF* dstar)
{
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJQA::SetMassLimits(Double_t range, Int_t pdg)
{
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJQA::SetMassLimits(Double_t lowlimit, Double_t uplimit)
{
  // Set the mass limits.
...
//_______________________________________________________________________________
Bool_t AliAnalysisTaskSEDmesonsFilterCJQA::SetD0WidthForDStar(Int_t nptbins, Float_t* width)
{
...
//_______________________________________________________________________________
Bool_t AliAnalysisTaskSEDmesonsFilterCJQA::DefineHistoForAnalysis()
{
...
//_______________________________________________________________________________
Float_t AliAnalysisTaskSEDmesonsFilterCJQA::DeltaR(AliVParticle *p1, AliVParticle *p2) const
{
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJQA::AddEventTracks(TClonesArray* coll, AliParticleContainer* tracks)
{
  //
...
//_______________________________________________________________________________
Double_t AliAnalysisTaskSEDmesonsFilterCJQA::AddDaughters(AliAODRecoDecay* cand, TObjArray& daughters)
{
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJQA::AddMCEventTracks(TClonesArray* coll, AliParticleContainer* mctracks)
{
    //
    // Add event tracks to a collection that already contains the D candidates, excluding the daughters of the D candidates
    //
...
//_______________________________________________________________________________
Double_t AliAnalysisTaskSEDmesonsFilterCJQA::AddMCDaughters(AliAODMCParticle* mcDmeson, TObjArray& mcdaughters, TClonesArray* mcArray)
{
    // Add all the dauthers of cand in an array. Follows all the decay cascades.
...
Int_t AliAnalysisTaskSEDmesonsFilterCJQA::CheckOrigin(AliAODRecoDecay* cand, TClonesArray* mcArray)
{
...
//_________________________________________________________________________________________________
Int_t AliAnalysisTaskSEDmesonsFilterCJQA::CheckOrigin(AliAODRecoDecay* cand, AliStack* stack)
{
  // Checks whether the mother of the D meson candidate comes from a charm or a bottom quark.
...
//_________________________________________________________________________________________________
Int_t AliAnalysisTaskSEDmesonsFilterCJQA::CheckOrigin(AliAODMCParticle* part, TClonesArray* mcArray)
{
  ...
  while (mother >= 0) {
    ...
    if (mcGranma != 0) {
      ...
      ::Error("AliAnalysisTaskSEDmesonsFilterCJQA::CheckOrigin", "Could not retrieve mother particle %d!", mother);
      break;
    }
  }
...
//_________________________________________________________________________________________________
Int_t AliAnalysisTaskSEDmesonsFilterCJQA::CheckOrigin(Int_t ipart, AliStack* stack)
{
  // Checks whether the mother of the particle comes from a charm or a bottom quark.
...
//_________________________________________________________________________________________________
Int_t AliAnalysisTaskSEDmesonsFilterCJQA::CheckDecayChannel(AliAODMCParticle* part, TClonesArray* mcArray)
{
...
//_________________________________________________________________________________________________
Int_t AliAnalysisTaskSEDmesonsFilterCJQA::CheckDecayChannel(Int_t ipart, AliStack* stack)
{
  // Determine the decay channel
...
void AliAnalysisTaskSEDmesonsFilterCJQA::GetTrackPrimaryGenerator(AliAODTrack *track,AliAODMCHeader *header,TClonesArray *arrayMC,TString &nameGen){
...
//----------------------------------------------------------------------
Bool_t AliAnalysisTaskSEDmesonsFilterCJQA::IsTrackInjected(AliAODTrack *track,AliAODMCHeader *header,TClonesArray *arrayMC){
...
//_____________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJQA::GetMCTrackPrimaryGenerator(AliAODMCParticle *track,AliAODMCHeader *header,TClonesArray *arrayMC,TString &nameGen){
...
//----------------------------------------------------------------------
Bool_t AliAnalysisTaskSEDmesonsFilterCJQA::IsMCTrackInjected(AliAODMCParticle *track,AliAODMCHeader *header,TClonesArray *arrayMC){
  /// method to check if a track comes from the signal event or from the underlying Hijing event
  TString nameGen;
